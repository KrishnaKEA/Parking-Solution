...
<footer class="bg-gray-800 pt-10 sm:mt-10 pt-10">
    ...
    <div class="pt-2">
        <div class="flex pb-5 px-3 m-auto pt-5 
            ...
            <div class="mt-2">
                OAK © Copyright 2022. All Rights Reserved. 
            </div>
            <br>
            <div>
                <a href="https://github.com/adrian52x/OAK" rel="noopener nofollow noreferrer" class="flex items-center py-2 px-4 mr-3 text-xs font-medium text-gray-900 bg-white rounded-lg border border-gray-200 focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
